    ...
    },
{
    ...
    },
    {
      id: "p-af19c5",
      title: "派大星和海绵宝宝穿唐朝服饰",
      titleEn: "派大星和海绵宝宝穿唐朝服饰",
      description: "派大星和海绵宝宝穿唐朝服饰",
      prompt: `身上穿着唐朝服饰的一只派大星，自然逼真，北宋时期风格油画暗棕褐色旧版图高清，精细工笔，精细流畅、柔韧有力、充满韵律感。衣纹的勾勒，疏密有致。用色典雅，善于运用对比色，丰富和谐，头戴唐朝帽子，`,
      tags: ["AI生成"],
      source: "@op7418",
      previewImage: "https://pbs.twimg.com/media/G3tsz5CWsAAXGuM.jpg?format=jpg&name=large",
      nodeTemplate: { requiresImageInput: false, generatorType: "pro", aspectRatio: "1:1" },
    },
    {
      id: "p-538496",
      ...
      tags: ["AI生成"],
      source: "@songguoxiansen",
      previewImage: "https://pbs.twimg.com/media/G6RRUtnbYAAhPZd.jpg",
      nodeTemplate: { requiresImageInput: false, generatorType: "pro", aspectRatio: "1:1" },
    },
    {
      id: "p-ac4f4d",
    ...
    },
    {
      id: "p-1a1f6e",
      title: "水墨画风格与写实摄影的结合",
      titleEn: "水墨画风格与写实摄影的结合",
      description: "水墨画风格与写实摄影的结合",
      prompt: `水墨画风格与写实摄影的结合。云雾缭绕的深山悬崖边，有一座摇摇欲坠的古老木质茶馆。茶馆门口挂着一副巨大的对联，随风飘扬。上联写：“进门不问人间事”，下联写：“喝茶只谈山海经”。横批是一块斑驳的牌匾：“神仙也得排队”。`,
      tags: ["风格", "AI生成"],
      source: "@songguoxiansen",
      previewImage: "https://pbs.twimg.com/media/G6NVDc0acAkj8HI.jpg",
      nodeTemplate: { requiresImageInput: false, generatorType: "pro", aspectRatio: "16:9" },
    },
    {
      id: "p-e29d6c",
      title: "潮流插画风格，一个穿着国潮服饰的少年",
      titleEn: "潮流插画风格，一个穿着国潮服饰的少年",
      description: "潮流插画风格，一个穿着国潮服饰的少年",
      prompt: `潮流插画风格，一个穿着国潮服饰的少年正在玩滑板，滑板底部绘有醒狮图案。背景是涂鸦风格的街头墙壁，墙上喷涂着巨大的汉字“国潮”。色彩高饱和度，动感十足。`,
      tags: ["风格", "插画"],
      source: "@songguoxiansen",
      previewImage: "https://pbs.twimg.com/media/G6NR5mpacAYGp6Z.jpg",
