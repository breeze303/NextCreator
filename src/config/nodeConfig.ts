...
export const nodeCategories: NodeCategory[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      {
        type: "openaiImageGeneratorNode",
        label: "OpenAI 通用绘图",
        description: "通用 OpenAI Images API 兼容图片生成（可自定义模型名）",
        icon: "Wand2",
        defaultData: {
          label: "OpenAI 通用绘图",
          model: "gpt-image-1",
      ...
      {
        type: "qwenImageGeneratorNode",
        label: "Qwen 绘图",
        description: "硅基流动 Qwen 图片生成（/v1/images/generations）",
        icon: "Sparkles",
        defaultData: {
          label: "Qwen 绘图",
